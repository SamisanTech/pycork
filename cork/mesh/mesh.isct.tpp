...
template <class VertData, class TriData>
inline GeomBlob<Eptr> Mesh<VertData, TriData>::IsctProblem::edge_blob(
    Eptr e)
{
    GeomBlob<Eptr> blob;
...
template <class VertData, class TriData>
inline void Mesh<VertData, TriData>::subdivide_tri(
